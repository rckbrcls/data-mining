...
- Context vocabulary: 20 dimensions shared by all three experiments.
...
Generated inputs and raw DAMICORE runs are under `artifacts/work/` and are ignored by
Git. Aggregate tables, figures, trees, and comparison summaries are under
`artifacts/results/` and do not export `source_hash`.
